#!/usr/bin/env python3
"""
Build DuckDB database with EXACT schema matching MSSQL.
Uses schema.json to generate DDL, then loads CSV data.
"""
import duckdb
import os
import json
...
# Fix VARCHAR(-1) → VARCHAR (unlimited)
def fix_type(t):
